int dacPin = 25;  // Choose a DAC pin (GPIO25 or GPIO26)
...
// Notes of the Tetris melody (in Hz)
int melody[] = {
  ...
  NOTE_E5, NOTE_C5, NOTE_E5, NOTE_D5, NOTE_C5, NOTE_B4, NOTE_C5, NOTE_D5,
  NOTE_E5, NOTE_C5, NOTE_A4, NOTE_A4
};

// Durations of the notes (1 = quarter note, 2 = eighth note, etc.)
int noteDurations[] = {
  8, 16, 16, 8, 16, 16, 8, 8,
  8, 16, 16, 8, 16, 16, 8, 8,
  8, 8, 8, 8, 16, 16, 8, 16,
...
void playTone(int frequency, int duration) {
  ...
  for (int i = 0; i < duration * 1000; i += period) {
    dacWrite(dacPin, 255);  // High level
    delayMicroseconds(halfPeriod);
    dacWrite(dacPin, 0);    // Low level
    delayMicroseconds(halfPeriod);
  }
}
